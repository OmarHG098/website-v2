...
const DoubleActionCTA = ({ session, location, ctaData, lang = "us" }) => {
    ...
    >
      ...
      >
        ...
        >
          <Div margin="0" flexDirection="column">
            <H3
              ...
              textAlign="left"
            >
              {content?.cta?.primary?.title || "Book Your Career Consultation"}
            </H3>
            <Paragraph
              fontSize="1rem"
              color={Colors.lightGray3}
          ...
          {content?.cta?.primary?.image?.childImageSharp && (
            <GatsbyImage
              style={{
                height: "auto",
                width: "100%",
          ...
          <Link to={content?.cta?.primary?.action_url} target="_blank">
            <Button
              ...
              margin="1.5rem 0"
            >
              <Icon icon="calendar" width="18px" height="18px" />
              <span>
        ...
        >
          ...
          {content?.cta?.secondary?.image?.childImageSharp && (
            <GatsbyImage
              style={{
                height: "auto",
                width: "100%",
          ...
          {formStatus.status === "thank-you" ? (
            <Div alignItems="center" flexDirection="column">
              <H3
                ...
                textAlign="center"
              >
                {content?.cta?.secondary?.newsletter_form?.success_message}
              </H3>
            </Div>
          ) : (
            <Div justifyContent="center" width="100%" margin="1.5rem 0">
              <Form
                ...
                onSubmit={async (e) => {
                  ...
                  if (formStatus.status === "error") {
                    setFormStatus({
                      status: "idle",
                      msg: content?.cta?.secondary?.newsletter_form?.status_idle || "Request"
                    });
                  }
                  if (!formIsValid(formData)) {
                    setFormStatus({
                      status: "error",
                      msg: content?.cta?.secondary?.newsletter_form?.status_error || "There are errors in your form"
                    });
                  } else {
                    setFormStatus({
                      status: "loading",
                      msg: content?.cta?.secondary?.newsletter_form?.button_loading || "Loading..."
                    });
                    ...
                    newsletterSignup(
                      ...
                      .then((data) => {
                        if (
                          ...
                          setFormStatus({
                          status: "error",
                          msg: content?.cta?.secondary?.newsletter_form?.status_correct_errors || "Correct the errors"
                        });
                        } else {
                          setFormStatus({
                          status: "thank-you",
              ...
              >
                <Input
                  ...
                  width="100%"
                  height="46px"
                  placeholder={content?.cta?.secondary?.newsletter_form?.placeholder_email || "Enter your email address"}
                  borderRadius="8px"
                  ...
                  errorMsg={content?.cta?.secondary?.newsletter_form?.error_email || "Please enter a valid email"}
                  required
                />
                ...
                <Button
                  ...
                  padding="14px 24px"
                  padding_tablet="14px 24px"
                  background={formStatus.status === "loading" ? Colors.darkGray : 'oklch(.97 0 0)'}
                  type="submit"
                  borderRadius="8px"
                  fontWeight="600"
                  justifyContent="center"
                ...
                >
                  {formStatus.status === "loading"
                    ? content?.cta?.secondary?.newsletter_form?.button_loading || "Loading..."
                    : <><Icon icon="mail" width="18px" height="18px" /><span>{content?.cta?.secondary?.newsletter_form?.button_submit || "Subscribe to Newsletter"}</span></>}
                </Button>
              </Form>
            </Div>
          )}
